...
6) En las siguientes graficas, podemos ver como exponiamos la data para conectarnos con APIC (Client_id y Client_Secret) y como los hemos ocultado en Vault ahora...
