...
Porque no probamos y testeamos desde la UI de APIC la API? 

Porque no se va a permitir la conexion entre APIC y el servidor que tiene la API SOAP. En estos momentos, la aplicacion corre en APACHE via HTTP y para conectarnos a APIC vamos a necesitar HTTPS. 
