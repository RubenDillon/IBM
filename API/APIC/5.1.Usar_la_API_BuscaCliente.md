...
1) Para poder hacer uso de APIC en nuestra aplicacion, debemos modificar el proxy que hemos definido en la VM2 (la que publica la API). Para ello debemos editar el archivo /etc/httpd/conf/httpd.conf y cambiar donde dice
