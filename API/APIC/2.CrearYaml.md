...
"Tengo una API y necesito generar un YAML con su definición. Me prodrias ayudar en generar el YAML de esta API [http://169.59.190.191:8080/api_proxy/clientes.php?id=1](http://169.59.164.213:8080/api/clientes.php?id=2)"
