...
1) Ingresar al API Connect Manager y seleccionar **Manage**. Alli vemos que existe un Catalogo creado por defecto. Ese catalogo es utilizado para desarrollo y no se lo puede borrar. En este paso, crearemos un nuevo Catalogo llamado Produccion. Para ello, en esta pagina seleccionamos el botón **Add** y luego **Create Catalog**. El Catalogo que esta creado por defecto **Sandbox**, no se puede borrar y es el que se usa para probar. Por ejemplo, creamos el catalogo **Produccion**
