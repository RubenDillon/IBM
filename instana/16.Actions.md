...
1. We could learn of what happen in this situation. We could review the events and try to catch the first event and execute. For that, we review the events when the event occurs
