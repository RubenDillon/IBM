...
# Configuración
DOMAIN="ibmconcert"
TOKEN="7842c7a3-a5f5-4001-8691-6af0c799dce0"
FULL_DOMAIN="$DOMAIN.duckdns.org"
IP="52.118.151.40"
EMAIL="tu-email@example.com"  # Cambiá esto por tu email real
...
# Paso 3: Solicitar certificado SSL vía DNS-01 con Docker
echo "→ Solicitando certificado SSL con Let's Encrypt..."
docker run --rm -it \
  -v "$CERT_DIR:/etc/letsencrypt" \
  -v "$CREDENTIALS_DIR:/duckdns" \
  deliverous/certbot-dns-duckdns \
  certonly \
  --dns-duckdns \
