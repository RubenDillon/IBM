...
grype / -o cyclonedx-json > web.json
...
Para Grype, deberiamos crear el siguiente archivo
...
curl -X POST \
  ...
  -H 'Content-Type: multipart/form-data' \
  -F "data_type=vulnerability_scan" \
  -F "filename=@/tmp/web.json;filename=web.json" \
  -F 'metadata={"scanner_name":"grype","scanner_version":"0.79.0"}'

```

y deberiamos ver una respuesta similar al siguiente grafico (202 Acceptance)

<img width="1623" height="134" alt="image" src="https://github.com/user-attachments/assets/91df1053-2d11-4810-943b-fd2609213a8d" />
